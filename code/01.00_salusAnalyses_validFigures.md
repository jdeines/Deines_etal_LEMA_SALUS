...
##  [1] Rcpp_1.0.6       plyr_1.8.4       cellranger_1.1.0 pillar_1.3.1    
##  [5] compiler_3.5.1   tools_3.5.1      digest_0.6.16    lubridate_1.7.4 
##  [9] jsonlite_1.7.2   evaluate_0.11    nlme_3.1-137     gtable_0.2.0    
## [13] lattice_0.20-35  pkgconfig_2.0.2  rlang_0.4.5      cli_2.2.0       
## [17] rstudioapi_0.7   yaml_2.2.0       haven_1.1.2      gridExtra_2.3   
## [21] withr_2.1.2      xml2_1.2.0       httr_1.3.1       knitr_1.20      
## [25] generics_0.0.2   hms_0.4.2        rprojroot_1.3-2  grid_3.5.1      
## [29] tidyselect_0.2.5 glue_1.4.2       R6_2.5.0         fansi_0.4.2     
## [33] readxl_1.1.0     rmarkdown_1.10   modelr_0.1.2     magrittr_2.0.1  
## [37] backports_1.1.2  scales_1.0.0     htmltools_0.3.6  rvest_0.3.2     
## [41] assertthat_0.2.1 colorspace_1.3-2 stringi_1.2.4    lazyeval_0.2.1  
...
## 
## Call:
## lm(formula = yield_median_kgha ~ stateNassYields, data = actuallySimple)
## 
## Residuals:
...
## 
## Call:
## lm(formula = yield_median_kgha ~ sheridanNassYields, data = actuallySimpleCounty)
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1852.4  -698.0   375.8   803.2   978.7 
## 
## Coefficients:
##                     Estimate Std. Error t value Pr(>|t|)    
## (Intercept)        1.111e+03  8.834e+02   1.258 0.255195    
## sheridanNassYields 8.615e-01  9.595e-02   8.979 0.000107 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1122 on 6 degrees of freedom
## Multiple R-squared:  0.9307,	Adjusted R-squared:  0.9192 
## F-statistic: 80.62 on 1 and 6 DF,  p-value: 0.0001067
```
