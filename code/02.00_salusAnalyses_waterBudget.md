...
##  [9] pillar_1.3.1     glue_1.4.2       withr_2.1.2      modelr_0.1.2    
## [13] readxl_1.1.0     plyr_1.8.4       munsell_0.5.0    gtable_0.2.0    
## [17] cellranger_1.1.0 rvest_0.3.2      evaluate_0.11    knitr_1.20      
## [21] fansi_0.4.2      broom_0.5.2      Rcpp_1.0.6       scales_1.0.0    
## [25] backports_1.1.2  jsonlite_1.7.2   gridExtra_2.3    hms_0.4.2       
## [29] digest_0.6.16    stringi_1.2.4    grid_3.5.1       rprojroot_1.3-2 
## [33] cli_2.2.0        tools_3.5.1      magrittr_2.0.1   lazyeval_0.2.1  
## [37] crayon_1.3.4     pkgconfig_2.0.2  xml2_1.2.0       lubridate_1.7.4 
## [41] assertthat_0.2.1 rmarkdown_1.10   httr_1.3.1       rstudioapi_0.7  
## [45] R6_2.5.0         nlme_3.1-137     compiler_3.5.1
```
...
![](../figure/02.00_salusAnalyses_waterBudget/waterBudget_byYear-1.png)<!-- -->
...
![](../figure/02.00_salusAnalyses_waterBudget/inOut_byRegion-1.png)<!-- -->
...
![](../figure/02.00_salusAnalyses_waterBudget/netChange_byYear-1.png)<!-- -->
...
![](../figure/02.00_salusAnalyses_waterBudget/netChange_overall-1.png)<!-- -->
...
![](../figure/02.00_salusAnalyses_waterBudget/netChangeLine-1.png)<!-- -->
...
```
## [1] "irrigation" "recharge"   "precip"     "etac"       "esac"      
## [6] "epac"       "rofc"
```
...
![](../figure/02.00_salusAnalyses_waterBudget/waterBudget_byYear_all_supplement-1.png)<!-- -->
